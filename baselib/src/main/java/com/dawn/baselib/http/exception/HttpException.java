package com.dawn.baselib.http.exception;
...
public class HttpException extends Exception {
    ...
    public static final int API_CODE_ERROR_CODE = -4;//返回BaseResult.code!=0000异常
    public static final int DATA_NULL_ERROR_CODE = -5;//data返回的NULL异常
    public static final int DOWNLOAD_ERROR_CODE = -6;//下载错误
    private int code;
    ...
    public String getErrorInfo() {
        switch (code) {
            ...
            case API_CODE_ERROR_CODE:
                return getString("API_CODE_ERROR_CODE");
